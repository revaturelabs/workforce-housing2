...
{
  // NOTE: You can use the "Rename" command on the "Refactor" menu to change the class name "GraceService" in code, svc and config file together.
  // NOTE: In order to launch WCF Test Client for testing this service, please select GraceService.svc or GraceService.svc.cs at the Solution Explorer and start debugging.
